...
import sfit.be.elison.tvshowapp.Model.Actor;
import sfit.be.elison.tvshowapp.Model.Creator;
import sfit.be.elison.tvshowapp.Model.Genre;
import sfit.be.elison.tvshowapp.Model.Network;
...
public class ShowActivity extends AppCompatActivity {
    ...
    private static String SHOW_URL = getBaseUrl()+"/shows/id/";
    private static String SIMILARE_SHOW_URL = getBaseUrl()+"/shows/similare/id/";
