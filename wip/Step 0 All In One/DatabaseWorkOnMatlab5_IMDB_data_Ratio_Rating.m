% %we need splitted data for IMDB user and movie from step 4... 
% %reviewer ID must be sorted
% 
% [row , column] = size(rating_left_join_genre);
% 
% averageRating = table();
% ratioTable = table();
% 
...
% prev_movie_id = 0 ; 
% 
% for i = 1 : 1410273 %For all IMDB User
%     table_to_cell = table2cell(rating_left_join_genre(i,5));
%     user_id = cell2mat(table_to_cell);
%     
%     table_to_cell = table2cell(rating_left_join_genre(i,7));
%     movieId = cell2mat(table_to_cell);
%     
%     table_to_cell = table2cell(rating_left_join_genre(i,6));
%     rating = cell2mat(table_to_cell);
%     
%     
%     table_to_cell = table2cell(rating_left_join_genre(i,8));
...
%writetable(averageRating , 'C:\Users\Anirudha\Google Drive\NSU\CSE 470\Our Research Work\Data Sets\Manipulated Data\Matlab Works\Step 0 All In One\averageRating_579_IMDB_User.xls');
%writetable(ratioTable , 'C:\Users\Anirudha\Google Drive\NSU\CSE 470\Our Research Work\Data Sets\Manipulated Data\Matlab Works\Step 0 All In One\ratioTable_579_IMDB_User.xls');
